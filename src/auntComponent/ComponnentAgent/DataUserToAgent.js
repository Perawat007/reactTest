      ...
      <>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">IdCreate</StyledTableCell>
            <StyledTableCell align="right">RoleCreate</StyledTableCell>
        ...
        <TableBody>
          {items.map((row, key) => (
            <StyledTableRow key={key}>
              <StyledTableCell align="lift">{row.ID}</StyledTableCell>
              <StyledTableCell align="right">{row.Username}</StyledTableCell>
              <StyledTableCell align="right">{row.Active}</StyledTableCell>
              <StyledTableCell align="right">{row.Balance}</StyledTableCell>
              <StyledTableCell align="right">{row.IDCreate}</StyledTableCell>
              <StyledTableCell align="right">{row.RoleCreate}</StyledTableCell>
...
export default DataUserToAgent;